...
# import models
from DPSentimentModel import DPSentimentModel
...
if __name__ == '__main__':
    """
    Train a sentiment analysis classifier with a noise layer.
    """
    ...
    with tf.variable_scope('imdb', reuse=False):
        model = DPSentimentModel(dp_epsilon=4.0, dp_delta=0.5, attack_bound=0.25, batch_size=batch_size,
                                      lstm_size=lstm_size,
                                      max_len=max_len,
                                      keep_probs=0.8,
    ...
    with tf.variable_scope('imdb', reuse=True):
        test_model = DPSentimentModel(dp_epsilon=4.0, dp_delta=0.5, attack_bound=0.25, batch_size=batch_size,
                                           lstm_size=lstm_size,
    ...
    saver.save(sess, 'models/imdb_model_dp_eps_4_delta_05_sens_025_l2')
    print('All done')
